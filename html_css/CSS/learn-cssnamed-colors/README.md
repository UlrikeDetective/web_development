...
This project builds a dynamic, interactive grid of CSS named colors. Instead of a standard square grid, colors are presented as vertical columns in a single horizontal row, creating a unique "barcode" or "icicle" aesthetic where the length of each key represents the length of the color's name.
