...
const familiesOrder = ["Whites", "Yellows", "Oranges", "Reds", "Purples", "Blues", "Cyans", "Greens", "Greys", "Blacks"];
...
function showDetails(color) {
  ...
  document.getElementById("modal-color-display").style.backgroundColor = color.name;
  ...
  document.getElementById("modal-cmyk").textContent = `C:${cmyk.c}% M:${cmyk.m}% Y:${cmyk.y}% K:${cmyk.k}%`;
