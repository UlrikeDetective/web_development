  ...
  ### 1. Activate your Environment:
     -  conda activate django2026

  ### 2. Initialize the Project:
     -  Run this command inside the Django2026 folder:
        -  django-admin startproject config .
     -  (Note the `.` at the end is important! It installs the configuration in the current folder instead of making a
        new subfolder.)

  ### 3. Configure Settings:
     -  Open Django2026/config/settings.py and find INSTALLED_APPS. Add your new app:
        -  INSTALLED_APPS = [
               ...
  ...
  ### 4. Connect URLs:
     -  Open Django2026/config/urls.py and update it to include your stories:
